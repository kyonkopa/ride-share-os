...
module Types
  class FinanceDetailsType < Types::BaseObject
    ...
    field :average_revenue_per_car, Float, null: false, description: "Average revenue per car"
    field :average_revenue_per_month, Float, null: false, description: "Average revenue per month"
    ...
    field :total_revenue_all_time, Float, null: false, description: "Total revenue all time"
  end
end
