...
type ShiftEvent = RecentShiftEventsQueryQuery["recentShiftEvents"]["items"][0]
...
export function ActivityEventItem({ event }: ActivityEventItemProps) {
  ...
  return (
    <div className="flex items-start gap-3 p-3 border rounded-lg hover:bg-muted/50 transition-colors">
      <div className={`p-2 rounded-lg ${eventInfo.bgColor} ${eventInfo.color}`}>
      ...
      <div className="flex-1 min-w-0">
        ...
        {event.vehicleRange !== null && event.vehicleRange !== undefined && (
          <p className="text-sm text-muted-foreground">
