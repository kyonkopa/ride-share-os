...
export type VehiclesQueryQuery = { __typename?: 'Query', vehicles: Array<{ __typename?: 'Vehicle', id: string, globalId: string, make: string, model: string, licensePlate: string, yearOfManufacture: number, displayName: string, latestOdometer: number, latestRange: number, telematicsSource: number, createdAt: any, updatedAt: any }> };
